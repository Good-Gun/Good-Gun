...
class ApplicationClass : Application() {
    ...
    fun calculateMaxNut() {
        BMR = 88.362 + (13.397 * user.u_weight) + (4.799 * user.u_height) - (5.677 * user.u_age) //user.u_age도 등록해야함
        ...
        maxNutrition.saturated_fat = (calorie * if(user.u_age >= 19) 0.07 else 0.08).toInt()
