...
data class FoodEntity(
    ...
    // 기본 생성자
    // 이름, 열량, 탄수화물, 당류, 단백질, 지방, 트랜스지방, 포화지방, 콜레스테롤, 등록일자
    constructor() : this(0,  "is_sum_entity", 0, 0, 0, 0,0,0,0,0,LocalDate.now().toString())
    constructor(name: String) : this(0, name,  1, 2, 3, 0,0,0,0,0,LocalDate.now().toString())
    // 테스트 위해 1, 2, 3 수치 넣었음
}